...
;------------------------------------------------------------------------  
 ...
 macro ingresarInventario  
    ...
    okCodigo:
    aprobarProducto codigo;aca valida si existe o no
    ;si aprueba continua
...
;----------------------------------------------------------------------  
 ...
 macro ingresarCompra  ;aca el peo
    ...
    okCodigoC:
    realizarCompra codigo;aca valida codigo
    ;si pasa continua en realizar compra 
...
;----------------------------------------------------------------------  
 ...
 macro ingresarVenta  
    ...
    okCodigoV:
    realizarVenta codigo  ;validad si existe
       ;si existe continua
    imprimir ivCantidad
    mov cx,3
    mov si,0
...
;lee la tupla entera[1234-abcdefghijklmnopqrst-100-120@]              
    ...
    mov si,0
      ...
      ;aca el peo
       ...
       cmp tres,999
       jae noSePuede:
       ;ok hasta aca va bien pero pasa el valor de tres a nuevaCantidad bien?
         
       mov ax,0
       mov bx,0
               
       ;aca empieza la suma final
       mov ax,tres
       mov bl,10
       div bl ;Residuoah,Cocienteal
       add ah,48 
       ...
       finSumar: ;ok hora se escribir ;;;;;aca termina la suma, hora de escribir                      
        mov coincidencias,0
        mov al,2
        mov dx, offset ainventario
        mov ah, 3dh
    ...
    mov ah,40h
    int 21h   ;Escribe en el archivo la nueva existencia     
...
;lee la tupla entera[1234-abcdefghijklmno-100-1200@]              
...
;----------------------------------------------------------------------
;      Macro para la suma de cantidades  no Usada
;----------------------------------------------------------------------                                             
       macro sumarCantidad actual cantidad
       mov ax,0
       mov bx,0
       mov cx,0
